...
if tipo_apuesta == "Reembolso":
    ...
    with st.expander("⚙️ Parámetros específicos para apuesta con Rollover"):
        ...
        with col2:
            porcentaje_retencion = st.slider("🧲 Retención estimada tras completar rollover (%)", 0, 100, 95)
...
if st.button("🔍 Calcular"):
    if tipo_apuesta == "Dinero Real":
        ...
        resultado = calcular_rollover(importe, bono, porcentaje_retencion, rollover, cuota_a_favor, cuota_en_contra, comision)
    else:
